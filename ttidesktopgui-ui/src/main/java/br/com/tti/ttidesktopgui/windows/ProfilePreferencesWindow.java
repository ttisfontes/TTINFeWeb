...
public class ProfilePreferencesWindow extends Window {
	...
	private final BeanFieldGroup<Prod> fieldGroup;
	/*
	...
	public ProfilePreferencesWindow(final Prod user, final boolean preferencesTabOpen) {
		...
		fieldGroup = new BeanFieldGroup<Prod>(Prod.class);
